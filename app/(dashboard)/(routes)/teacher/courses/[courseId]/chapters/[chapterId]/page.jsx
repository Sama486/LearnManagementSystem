    ...
    return (
        <>
            {!chapter.isPublished && (
                <Banner
                    variant="warning"
                    label="This chapter is not published. It will not be available to students until you publish it."
                />
            )}
            <div className='p-6'>
                    ...
                    <div className='w-full'>
                        ...
                        <div className='flex items-center justify-between w-full'>
                            <div className='flex flex-col gap-y-2'>
                                ...
                                <span className='sm text-slate-700'>Complete all fields {completionText}</span>
                            </div>
                            <ChapterActions
                                disabled={!isComplete}
                                courseId={params.courseId}
